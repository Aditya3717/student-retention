...
const seedData = async () => {
    try {
        ...
        const studentUser = await User.create({
            ...
            password: 'password123', // User model's pre-save middleware will hash this if I use .create, but if I use save() it hashes it. 
            // Wait, checking User.js: userSchema.pre('save') handles hashing. So I just pass raw password.
            role: 'student'
        });
